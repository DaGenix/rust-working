...
use cryptoutil::{writeu64be, writeu32be, readu64vbe, readu32vbe, FixedBuffer128, FixedBuffer64};
use digest::Digest;
...
impl Engine512State {
    ...
    fn process_block(&mut self, data: &[u8]) {
        ...
        readu64vbe(W.mut_slice(0, 16), data);
...
impl Engine512 {
    ...
    fn finish(&mut self) {
        ...
        writeu64be(self.buffer.next(8), self.bit_counter.get_high_bit_count());
        writeu64be(self.buffer.next(8), self.bit_counter.get_low_bit_count());
        self.state.process_block(self.buffer.full_buffer());
...
impl Digest for Sha512 {
    ...
    fn result(&mut self, out: &mut [u8]) {
        ...
        writeu64be(out.mut_slice(0, 8), self.engine.state.H0);
        writeu64be(out.mut_slice(8, 16), self.engine.state.H1);
        writeu64be(out.mut_slice(16, 24), self.engine.state.H2);
        writeu64be(out.mut_slice(24, 32), self.engine.state.H3);
        writeu64be(out.mut_slice(32, 40), self.engine.state.H4);
        writeu64be(out.mut_slice(40, 48), self.engine.state.H5);
        writeu64be(out.mut_slice(48, 56), self.engine.state.H6);
        writeu64be(out.mut_slice(56, 64), self.engine.state.H7);
    }
...
impl Digest for Sha512Trunc224 {
    ...
    fn result(&mut self, out: &mut [u8]) {
        ...
        writeu64be(out.mut_slice(8, 16), self.engine.state.H1);
        writeu64be(out.mut_slice(16, 24), self.engine.state.H2);
        writeu32be(out.mut_slice(24, 28), (self.engine.state.H3 >> 32) as u32);
    }
...
impl Engine256State {
    ...
    fn process_block(&mut self, data: &[u8]) {
        ...
        readu32vbe(W.mut_slice(0, 16), data);
...
impl Engine256 {
    ...
    fn finish(&mut self) {
        ...
        writeu32be(self.buffer.next(4), (self.length >> 29) as u32 );
        writeu32be(self.buffer.next(4), (self.length << 3) as u32);
        self.state.process_block(self.buffer.full_buffer());
...
impl Digest for Sha256 {
    ...
    fn result(&mut self, out: &mut [u8]) {
        ...
        writeu32be(out.mut_slice(0, 4), self.engine.state.H0);
        writeu32be(out.mut_slice(4, 8), self.engine.state.H1);
        writeu32be(out.mut_slice(8, 12), self.engine.state.H2);
        writeu32be(out.mut_slice(12, 16), self.engine.state.H3);
        writeu32be(out.mut_slice(16, 20), self.engine.state.H4);
        writeu32be(out.mut_slice(20, 24), self.engine.state.H5);
        writeu32be(out.mut_slice(24, 28), self.engine.state.H6);
        writeu32be(out.mut_slice(28, 32), self.engine.state.H7);
    }
